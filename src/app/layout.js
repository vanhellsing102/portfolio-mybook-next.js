...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      <body
        className={`${geistSans.variable} ${geistMono.variable} antialiased min-h-screen bg-radial from-[#4e44b1] via-[#312c64] to-[#1c1c31] relative md:mt-5 md:mx-10 mx-7 mt-4`}
      >
